...
# $CXX_CMD -D_MTX_T_=double -D_MTX_N_=100 perf_nnmul.cpp -o perf_nnmul_fp64 $*
# $CXX_CMD -D_MTX_T_=_Float16 -D_MTX_N_=100 perf_nnmul.cpp -o perf_nnmul_fp16 -mcpu=cortex-a75+dotprod $*
